...
@media screen and (max-width:900px){ .ornekclass{ display: block; } }
@media screen and (max-width: 600px) {
    .nomobile {
        visibility: hidden; clear: both; float: right;
        margin: 5px auto; width: 22%; height: auto; display: none;
    }
}
</style>
${headerapi}
...
<div class="header-text"><p>Güncel adresimiz: <a href="https://${hostname}" target="_blank" rel="noopener" style="color:white;">${hostname}</a> - Sonraki adresimiz: <a href="https://${nextDomain}" target="_blank" rel="noopener" style="color:white;">${nextDomain}</a> olacaktır.</p></div>
...
${instagram ? `<a href="${instagram}" target="_blank" rel="noopener" aria-label="Instagram"><svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"></path></svg></a>` : ''}
${telegram ? `<a href="${telegram}" target="_blank" rel="noopener" aria-label="Telegram"><svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M446.7 98.6l-67.6 318.8c-5.1 22.5-18.4 28.1-37.3 17.5l-103-75.9-49.7 47.8c-5.5 5.5-10.1 10.1-20.7 10.1l7.4-104.9 190.9-172.5c8.3-7.4-1.8-11.5-12.9-4.1L117.8 284 16.2 252.2c-22.1-6.9-22.5-22.1 4.6-32.7L418.2 66.4c18.4-6.9 34.5 4.1 28.5 32.2z"></path></svg></a>` : ''}
${facebook ? `<a href="${facebook}" target="_blank" rel="noopener" aria-label="Facebook"><svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="currentColor" d="M279.14 288l14.22-92.66h-88.91V127.67c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S263.69 0 225.36 0C141.09 0 89.53 54.42 89.53 153.12v68.22H0V288h89.53v224h107.78V288z"></path></svg></a>` : ''}
${youtube ? `<a href="${youtube}" target="_blank" rel="noopener" aria-label="YouTube"><svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M549.655 124.083c-6.281-23.65-24.764-42.232-48.339-48.518C456.994 64 288 64 288 64s-168.994 0-213.316 11.565c-23.575 6.286-42.058 24.868-48.339 48.518C16 168.428 16 256 16 256s0 87.572 10.345 131.917c6.281 23.65 24.764 42.232 48.339 48.518C119.006 448 288 448 288 448s168.994 0 213.316-11.565c23.575-6.286 42.058-24.868 48.339-48.518C560 343.572 560 256 560 256s0-87.572-10.345-131.917zM232 336V176l142.857 80L232 336z"></path></svg></a>` : ''}
</div>
</div>
<header>
...
<div class="list-blink"></div><span>Maçlar</span>
</div>
<div data-focustab="next" id="next-tab" style="flex: 1; text-align: center; cursor: pointer;">
<div class="list-blink"></div><span>Kanallar</span>
</div>
</div>
<style>
...
.search-container input:focus { border: 1px solid rgba(255,255,255,0.3); }
...
${reklam2 ? `<div class="reklam-3" style="max-width:100%;height:100%;margin:0 auto;">${hrefreklam2 ? `<a href="${hrefreklam2}" target="_blank"><center><img src="${reklam2}" alt="reklamlar" /></center></a>` : `<center><img src="${reklam2}" alt="reklamlar" /></center>`}</div>` : ''}
${reklam5 ? `<div class="reklam-5" style="max-width:100%;height:100%;margin:0 auto;">${hrefreklam5 ? `<a href="${hrefreklam5}" target="_blank"><center><img src="${reklam5}" alt="reklamlar" /></center></a>` : `<center><img src="${reklam5}" alt="reklamlar" /></center>`}</div></div>` : ''}
<footer>
...
${reklam6 ? `<div style="position:fixed; bottom:0px; left:0; width:100%; text-align:center; z-index:999999;"><div style="position:relative; display:inline-block; max-width:100%;"><span onclick="this.parentNode.parentNode.style.display='none';" style="position:absolute; top:5px; right:5px; background:#49de80; color:black; width:25px; height:25px; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:16px; cursor:pointer; z-index:2; font-weight:bold; transition:all 0.3s;" onmouseover="this.style.transform='scale(1.1)'; this.style.background='#2f9354';" onmouseout="this.style.transform='scale(1)'; this.style.background='#49de80';">×</span>${hrefreklam6 ? `<a href="${hrefreklam6}" target="_blank" style="display:block;"><img src="${reklam6}" style="max-width:100%; height:auto; display:block; border-radius:6px;" /></a>` : `<img src="${reklam6}" style="max-width:100%; height:auto; display:block; border-radius:6px;" />`}</div></div>` : ''}
</body>
</html>`;
